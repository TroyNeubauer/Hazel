...
namespace Hazel {
	...
	public:
		...
		virtual void SetFloat  	(const char*, const float value) = 0;
		virtual void SetInt  	(const char*, const int value) = 0;
		virtual void SetFloat2 	(const char*, const glm::vec2& vec) = 0;
		virtual void SetFloat3 	(const char*, const glm::vec3& vec) = 0;
		virtual void SetFloat4 	(const char*, const glm::vec4& vec) = 0;
		virtual void SetMat3 	(const char*, const glm::mat3& mat) = 0;
		virtual void SetMat4 	(const char*, const glm::mat4& mat) = 0;
