...
namespace Hazel {
	...
	VulkanImGuiLayer::VulkanImGuiLayer()
	{
		...
		m_Context = (VulkanContext*) context;
	}

	void VulkanImGuiLayer::FrameRender()
	{
		ImGui_ImplVulkanH_WindowData* wd = &m_Context->m_WindowData;
		VkResult err;
	...
	void VulkanImGuiLayer::OnAttach()
	{
		...
		ImGui_ImplVulkan_Init(&init_info, m_Context->m_WindowData.RenderPass);

		// Upload Fonts
		{
			// Use any command queue
			VkCommandPool command_pool = m_Context->m_WindowData.Frames[m_Context->m_WindowData.FrameIndex].CommandPool;
			VkCommandBuffer command_buffer = m_Context->m_WindowData.Frames[m_Context->m_WindowData.FrameIndex].CommandBuffer;
